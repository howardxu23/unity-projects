...
using UnityEngine;
using Photon.Pun;
public class mobPathfinding : MonoBehaviourPunCallbacks
{
    public int speed = 1;
    [Tooltip("ensure waypoint has 'waypoint' tag")]
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            if (collision.gameObject.GetComponent<PlayerManager>().activated == false)
            {
